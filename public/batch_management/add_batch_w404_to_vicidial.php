...
<body>
    <h1>Add Batch Without 404 To Vicidial</h1>
    <?php
        ...
        function addNewBashOrdre(
            ...
            try {
                ...
                $sql = "INSERT INTO tb_bash_ordre 
                            (database_name, table_name, phone_code, number_use, id_lot, extra, id_user_connecte, status, type_add) 
                        VALUES 
                            (:database_name, :table_name, :phone_code, :number_use, :id_lot, :extra, :id_user_connecte, :status, :type_add  )";
    ...
    /** ---------- Get & sanitize GET params ---------- */
        ...
        // Check required fields
            if (!$selectDataBase || !$nameTable || !$phoneCode || !$numberUse || !$idLot || !$idUserConnecte) { die("❌ Missing required parameters."); }
